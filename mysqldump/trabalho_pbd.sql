...
-- Schema trabalho_pbd
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `trabalho_pbd` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trabalho_pbd`.`user` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trabalho_pbd`.`categoria` ;

CREATE TABLE IF NOT EXISTS `trabalho_pbd`.`categoria` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(45) NOT NULL,
  `tipo` INT NOT NULL COMMENT '0 ambas/ 1 receita/ 2 despesa',
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trabalho_pbd`.`situacao` ;
...
-- -----------------------------------------------------
-- Table `trabalho_pbd`.`conta`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trabalho_pbd`.`conta` ;

CREATE TABLE IF NOT EXISTS `trabalho_pbd`.`conta` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  `tipo` INT NULL COMMENT '0 despesa  | 1 receita\n',
  PRIMARY KEY (`id`),
  INDEX `fk_despesa_situacao_idx` (`situacao_id` ASC),
  INDEX `fk_despesa_user1_idx` (`user_id` ASC),
  INDEX `fk_despesa_categoria1_idx` (`categoria_id` ASC),
  CONSTRAINT `fk_despesa_situacao`
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trabalho_pbd`.`receita` ;
